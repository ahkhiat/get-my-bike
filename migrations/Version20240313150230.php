...
final class Version20240313150230 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE moto (id INT AUTO_INCREMENT NOT NULL, proprietaire_id INT DEFAULT NULL, marque_id INT DEFAULT NULL, annee VARCHAR(255) NOT NULL, couleur VARCHAR(255) NOT NULL, prix_jour INT NOT NULL, dispo TINYINT(1) NOT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', image_name VARCHAR(255) DEFAULT NULL, description LONGTEXT DEFAULT NULL, bagagerie TINYINT(1) NOT NULL, adresse_moto VARCHAR(255) DEFAULT NULL, code_postal_moto VARCHAR(5) DEFAULT NULL, ville_moto VARCHAR(255) DEFAULT NULL, cylindree VARCHAR(255) DEFAULT NULL, poids INT DEFAULT NULL, puissance INT DEFAULT NULL, options VARCHAR(255) DEFAULT NULL, INDEX IDX_3DDDBCE476C50E4A (proprietaire_id), INDEX IDX_3DDDBCE44827B9B2 (marque_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');

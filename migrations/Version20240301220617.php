 ...
 */
final class Version20240301220617 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE commentaire (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, moto_id INT NOT NULL, proprietaire_id INT NOT NULL, reservation_id INT DEFAULT NULL, note_moto INT DEFAULT NULL, texte_moto LONGTEXT DEFAULT NULL, note_proprio INT DEFAULT NULL, texte_proprio LONGTEXT DEFAULT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', INDEX IDX_67F068BCA76ED395 (user_id), INDEX IDX_67F068BC78B8F2AC (moto_id), INDEX IDX_67F068BC76C50E4A (proprietaire_id), UNIQUE INDEX UNIQ_67F068BCB83297E7 (reservation_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
